...
declare function local:pattern1(){<svrl:active-pattern xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
, local:rules(( local:pattern1-rule1#2), ( local:pattern1-rule1#0), ())};
declare function local:pattern1-rule1($Q{http://www.andrewsales.com/ns/xqs}context,$Q{http://www.andrewsales.com/ns/xqs}matched){if(exists($Q{http://www.andrewsales.com/ns/xqs}context) and empty($Q{http://www.andrewsales.com/ns/xqs}context intersect $Q{http://www.andrewsales.com/ns/xqs}matched)) then (
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//foo"/>
, $Q{http://www.andrewsales.com/ns/xqs}context! (local:pattern1-rule1-report1(.))) else ()};declare function local:pattern1-rule1-report1($Q{http://www.andrewsales.com/ns/xqs}context){ let $Q{http://www.andrewsales.com/ns/xqs}result:=$Q{http://www.andrewsales.com/ns/xqs}context/(.) return if($Q{http://www.andrewsales.com/ns/xqs}result) then <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" location="{path($Q{http://www.andrewsales.com/ns/xqs}context)}" test=".">
  <svrl:text>Hello, XQS world!</svrl:text>
</svrl:successful-report> else ()};
declare function local:pattern1-rule1(){$Q{http://www.andrewsales.com/ns/xqs}doc/(//foo)};
...
declare function local:schema(){<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl">{ local:pattern1(),local:patternphase-demo() }</svrl:schematron-output>};declare function local:rules(
  $rules as function(*)*,
