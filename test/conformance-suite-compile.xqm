...
:)
declare %unit:ignore function _:extends-baseuri-fixup1(){let $compiled:=compile:schema(
...
: @see XML Inclusions (XInclude) Version 1.1, Section 4.7.5. 
:)
declare %unit:ignore function _:include-baseuri-fixup1(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
...
function _:let-name-collision-error-021(){compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:let name="foo" value="'bar'"/>
        <sch:let name="foo" value="'bar'"/>
...
:)
declare %unit:test('expected', 'xqs:multiply-defined-variable') 
function _:let-name-collision-error-031(){compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:let name="foo" value="'bar'"/>
      <sch:let name="foo" value="'bar'"/>
      <sch:pattern>
...
:)
declare %unit:test('expected', 'xqs:multiply-defined-variable') 
function _:let-name-collision-error-041(){compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:phase id="phase">
        <sch:let name="foo" value="'bar'"/>
        <sch:let name="foo" value="'bar'"/>
...
: @see ISO Schematron 2016: Section 5.4.5 Clause 3 
:)
declare %unit:test function _:let-name-collision-error-051(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:let name="foo" value="'bar'"/>
      <sch:pattern>
        <sch:let name="foo" value="'bar'"/>
...
: @see ISO Schematron 2016: Section 5.4.5 clause 3 
:)
declare %unit:test function _:let-name-collision-error-061(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
...
function _:let-reference-undefined-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
...
:)
declare %unit:test('expected', 'err:XPST0008')
function _:let-reference-undefined-021(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="*">
...
:)
declare %unit:test('expected', 'err:XPST0008')
function _:let-reference-undefined-031(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="*">
...
:)
declare %unit:test('expected', 'err:XPST0008')
function _:let-reference-undefined-041(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="*">
...
:)
declare %unit:test('expected', 'err:XPST0008')
function _:let-reference-undefined-051(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="*">
...
:)
declare %unit:test('expected', 'err:XPST0008')
function _:let-reference-undefined-061(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="*">
          <sch:assert test="false()">
...
:)
declare %unit:test('expected', 'err:XPST0008')
function _:let-reference-undefined-071(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
...
:)
declare %unit:test function _:let-rule-global-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
...
: @see ISO Schematron 2016: Section 6.5 clause 6 
:)
declare %unit:test function _:let-rule-global-021(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:phase id="phase">
...
:)
declare %unit:test function _:let-scope-pattern-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
...
: @see ISO Schematron 2016: Section 3.26 
:)
declare %unit:test function _:let-scope-phase-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:let name="foo" value="0"/>
      <sch:phase id="phase">
        <sch:let name="foo" value="1"/>
...
: @see ISO Schematron 2016: Section 3.26 
:)
declare %unit:test function _:let-scope-rule-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="/">
          <sch:let name="foo" value="1"/>
...
:)
declare %unit:test function _:let-value-element-content-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
...
: @see ISO Schematron 2016: Section 5.4.5 clause 2 
:)
declare %unit:test function _:let-value-element-content-012(){let $compiled:=compile:schema(
...
:)
declare %unit:ignore function _:pattern-abstract-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
...
:)
declare %unit:ignore function _:rule-abstract-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
...
: @see ISO Schematron 2016: Section 5.4.12 clause 5 
:)
declare %unit:ignore function _:rule-abstract-021(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule abstract="true" id="abstract-rule">
          <sch:report test="self::element"/>
...
:)
declare %unit:test function _:rule-context-attribute-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
...
: @see ISO Schematron 2016: Annex C Clause 2 (xslt), Annex H Clause 2 (xslt2), Annex I Clause 2 (xpath2) 
:)
declare %unit:test function _:rule-context-comment-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
...
: @see ISO Schematron 2016: Annex C Clause 2 (xslt), Annex H Clause 2 (xslt2), Annex I Clause 2 (xpath2) 
:)
declare %unit:test function _:rule-context-element-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="/element">
          <sch:assert test="false()"/>
...
: @see ISO Schematron 2016: Annex C Clause 2 (xslt), Annex H Clause 2 (xslt2), Annex I Clause 2 (xpath2) 
:)
declare %unit:test function _:rule-context-pi-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
...
:)
declare %unit:test function _:rule-context-root-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="/">
          <sch:assert test="false()"/>
...
: @see ISO Schematron 2016: Annex C Clause 2 (xslt), Annex H Clause 2 (xslt2) 
:)
declare %unit:test function _:rule-context-text-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
...
: @see  
:)
declare %unit:test function _:rule-context-variable-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
...
: @see  
:)
declare %unit:test function _:rule-context-variable-021(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:phase id="phase">
        <sch:let name="local-name" value="'document'"/>
        <sch:active pattern="pattern"/>
...
: @see  
:)
declare %unit:test function _:rule-context-variable-031(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:let name="local-name" value="'document'"/>
      <sch:pattern>
        <sch:rule context="*[local-name() = $local-name]">
...
:)
declare %unit:test function _:rule-order-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="element">
          <sch:assert test="true()"/>
...
:)
declare %unit:test function _:schema-default-phase-011(){let $compiled:=compile:schema(
...
:)
declare %unit:ignore function _:xslt-key-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
...
:)
declare %unit:ignore function _:xslt-key-element-content-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
...
:)
declare %unit:test function _:svrl-diagnostic-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="/">
...
:)
declare %unit:test function _:svrl-name-nopath-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="/element">
...
: @see ISO Schematron 2016: Section 5.4.6, Annex C clause 4 (xslt), Annex H clause 4 (xslt2), Annex I clause 4 (xpath2) 
:)
declare %unit:test function _:svrl-name-path-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="/element">
          <sch:report test="true()">
...
:)
declare %unit:test function _:svrl-property-copy-of1(){let $compiled:=compile:schema(
...
:)
declare %unit:test function _:svrl-value-of-011(){let $compiled:=compile:schema(
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="tag:dmaus@dmaus.name,2019:Schematron:Testsuite">
      <sch:pattern>
        <sch:rule context="/element">
          <sch:report test="true()">
